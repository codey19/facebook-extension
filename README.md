...
Facebook progressively sets cookies while you browse to detect that you're not logged in, eventually hitting you with a forced login wall. The extension prevents this in two ways:
