...
Facebook progressively sets cookies while you browse to detect that you're not logged in, eventually hitting you with a forced login wall. The extension prevents this by
- wiping any existing Facebook cookies the moment you navigate to the site
- blocking Facebook's servers from setting new cookies while you're on the page

Therefore, Facebook never accumulates enough session data to know who you are or trigger the login prompt.
